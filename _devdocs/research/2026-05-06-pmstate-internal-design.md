# pmstate — internal design (v1)

**Date:** 2026-05-06
**Status:** Adopted as the v1 design baseline. Q1–Q7 resolved. Event protocol choice deferred. External validation pending (see `2026-05-06-pmstate-external-validation.md`).
**Origin:** Prior-session brainstorm with another Claude (originally `process_flow_agent_framework_concept.md`, retained alongside for provenance).
**Confirmed scope additions (this session):** Python ≥ 3.11. v0.1 target Laterite process: **procurement** (vendor quotes, LPO events, approvals).

*Working document. Q1–Q7 review complete. Event bus requirements locked in; specific protocol choice deliberately left open pending real use.*
